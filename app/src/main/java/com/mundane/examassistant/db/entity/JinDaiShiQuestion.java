...
@Entity
public class JinDaiShiQuestion {
    ...
    @Generated(hash = 140987244)
    public JinDaiShiQuestion(Long id, String question, String optionA,
    ...
    @Generated(hash = 395320514)
    public JinDaiShiQuestion() {
    }
    public Long getId() {
        return this.id;
    }
