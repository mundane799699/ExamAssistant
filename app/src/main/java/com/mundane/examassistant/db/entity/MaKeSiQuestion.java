...
public class MaKeSiQuestion {
    ...
    @Generated(hash = 2004596566)
    public MaKeSiQuestion(Long id, String question, String optionA, String optionB,
    ...
    @Generated(hash = 1939010281)
    public MaKeSiQuestion() {
    }
    public Long getId() {
        return this.id;
    }
