 ...
 * @description :
 * @file : SiXiuQuestion.java
 */

@Entity
public class SiXiuQuestion {
    ...
    private boolean isAnsweredWrong;
				@Generated(hash = 1198406449)
				public SiXiuQuestion(Long id, String question, String optionA, String optionB,
						String optionC, String optionD, String answer, boolean isCollected,
				...
				@Generated(hash = 752290406)
				public SiXiuQuestion() {
				}
				public Long getId() {
					return this.id;
				}
