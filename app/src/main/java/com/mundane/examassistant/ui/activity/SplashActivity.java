...
import com.mundane.examassistant.db.entity.JinDaiShiQuestion;
import com.mundane.examassistant.db.entity.MaKeSiQuestion;
import com.mundane.examassistant.db.entity.MaoGaiXiaQuestion;
    ...
    private void inputDataToDbByFirstChar(String firstChar, QuestionBean.PlistBean.ArrayBean.DictBean dictBean, int index) {
        ...
        switch (firstChar) {
            ...
            case "毛":
                ...
                DbHelper.getMaoGaiXiaQuestion().insert(maoGaiXiaQuestion);
                break;
            case "近":
